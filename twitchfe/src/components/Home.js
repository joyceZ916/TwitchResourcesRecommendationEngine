...
const Home = ({ resources, loggedIn, favoriteItems, favoriteOnChange }) => {
  ...
  return (
    ...
    >
      <TabPane tab="Streams" key={tabKeys.Streams} style={{ height: '960px', overflow: 'auto' }} forceRender={true}>
        {renderCardGrid(STREAM, loggedIn, favStreams, favoriteOnChange)}
      </TabPane>
      <TabPane tab="Videos" key={tabKeys.Videos} style={{ height: '960px', overflow: 'auto' }} forceRender={true}>
        {renderCardGrid(VIDEO, loggedIn, favVideos, favoriteOnChange)}
      </TabPane>
      <TabPane tab="Clips" key={tabKeys.Clips} style={{ height: '960px', overflow: 'auto' }} forceRender={true}>
